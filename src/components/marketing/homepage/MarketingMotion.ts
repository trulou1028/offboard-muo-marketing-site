...
export function animateContextExample(output: HTMLElement) {
  return animate(
    output,
    { opacity: [0.58, 1], transform: ["translateY(4px)", "translateY(0px)"] },
    {
      duration: MARKETING_MOTION.contextExampleDuration,
      ease: MARKETING_MOTION.navigationEase,
    },
  );
}
