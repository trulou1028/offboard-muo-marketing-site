  ...
  return (
    <section className="mh-hero" id="top">
      <div className="mh-hero-inner">
        ...
        <small className="mh-hero-trust"><LockKeyhole aria-hidden="true" />No credit card required. Benefit facts are verified by people, never generated by AI. Offboard is independent, not a government agency, and claiming your benefits is always free.</small>
      </div>
    </section>
  );
}
