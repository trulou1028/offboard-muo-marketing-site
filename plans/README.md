...
| 045 | Product dropdown and its five pages back in the launch set; `/how-it-works` deferred instead (owner reversal 2026-09-07); then a messaging polish pass on the five product pages with visual suggestions | P1 | M | 043, 044 | **Part 1 BUILT 2026-09-07** on `claude/plan-045-product-pages-back` (the structure swap). Part 2, the messaging pass, follows as its own plan doc and PR. |
