...
| 041 | /layoff-support rebuilt around stabilization: the first week, Paperwork Review, benefits rows, and a "been out a while" band; every new number ledger-backed | P1 | M | 030, 033, 039 | TODO - written 2026-09-04 from the owner's design critique; copy drafts need owner sign-off; five numbers need ledger rows before build |
