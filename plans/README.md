...
| 038 | Company Transition Centers (`/companies` + per-company pages) - the last roadmap item | P2 | M | 026, 037 | IN PROGRESS - owner said go 2026-09-01 and added Airtable; branch `claude/company-pages`, six pages built from sourced public record, awaiting owner preview sign-off |
