...
| 038 | Company Transition Centers (`/companies` + per-company pages) - the last roadmap item | P2 | M | 026, 037 | WRITTEN SCOPE ONLY - five owner decisions open (go/not yet, the five companies, the HR band, the public name, stale-page policy). Recommends a five-page hand-written pilot, no data plumbing, measured for four weeks; grounded in the owner's own 2026-08-14 analysis in the app repo |
