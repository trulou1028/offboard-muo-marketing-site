...
| 037 | Dropdown navigation (Product / For Organizations / Resources) | P1 | M | 026, 036 | IN PROGRESS - branch `claude/dropdown-nav`, awaiting owner preview sign-off. **Phase 4 done.** Four defects found in verification, incl. `hidden` not hiding the panels |
