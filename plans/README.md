...
| 023 | Civic Modern rollout to every route (tokens promoted to base scope; lime->AI-only site-wide; on-dark whites to the paper family) | P1 | M | 021, 022 | IN PROGRESS - branch `claude/civic-modern-rollout`, stacked on the plan-022 repair/polish PR #43, awaiting owner preview sign-off |
| 024 | Interactive quick wins (sticky nav, Home link, neon dark-band CTAs, calm motion pass) | P1 | M | 023 | IN PROGRESS - branch `claude/interactive-quick-wins`, stacked on PR #44, awaiting owner preview sign-off |
| 025 | Career Context pillar page (/career-context; homepage h2 widened; chat primitives shared) | P1 | M | 024 | IN PROGRESS - branch `claude/career-context-page`, stacked on PR #45; page copy needs owner sign-off |
