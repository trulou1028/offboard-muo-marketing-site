...
| 027 | Footer depth (deliberate third green + hairline so the footer stops merging into the last section) | P2 | S | 023 | IN PROGRESS - branch `claude/footer-depth`, awaiting owner preview sign-off |
