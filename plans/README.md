...
| 040 | Copy and messaging narrative audit, then execution: four-step spine, one sitewide CTA, app-verified tool glossary, casing and duplicate-copy sweeps | P1 | M | 039 | **BUILT** on `claude/homepage-composition`. Owner decisions 2026-09-03: four steps, `Get started free` everywhere. Two items deliberately NOT swept and recorded instead: `Job Packet` vs `Application Packet` (sits inside an owner-confirmed price fact) and `Career Context` vs the app's `Your Record`. `npm test` 170/170, `npm run e2e` 105/105; all 60 visual baselines re-captured because the header CTA changed sitewide |
| 039 | Homepage visual audit, composition rules, product compositions, and the build / connect / run narrative | P1 | L | 022, 038 | **BUILT through round 4** on `claude/homepage-composition` ([PR #62](https://github.com/trulou1028/offboard-muo-marketing-site/pull/62)). Round 4 (owner, 2026-09-02): the homepage names things and the pillar pages describe them. Ten tool descriptions moved to `/job-search`, eight Career Context categories to `/career-context`, the member questions became a disclosure list, and the five static FAQ sections became real accordions. New rule R5a and Pattern H. Mobile 14,776px to 12,859px. Awaiting owner go. `npm test` 170/170, `npm run e2e` 105/105 |
