...
| 050 | Context first: the homepage and `/how-it-works` tell the app's four stages (Build your Career Context, Bring your AI, Run your search, Follow your path) in the app's order; "Steady the first week" becomes stage 4's content and what Lumo raises first | P1 | M | 044 | **PLAN WRITTEN 2026-09-10.** Owner direction 2026-09-10; source `lumo-plan-builder` `origin/main` `1d3ef74c9` (`NEXT_STAGES`, plan 277 appendix). Two copy decisions open. Branch `claude/plan-050-context-first-sequence`. |
