...
| 051 | `/job-search` earns the link the homepage now sends it: a new Application Packet band (the six real steps, Free/Pro chips), the four-column stage grid rebuilt as the PR #90 rows, a Straight answers band, the orphan photograph out, the copy-law CTA drift fixed | P1 | M | PR #90, PR #91 | **PLAN WRITTEN 2026-09-11.** Owner audit request 2026-09-11 after the Step 3 rebuild. Three decisions open. Branch `claude/plan-051-job-search`. |
