...
> **Execute with:** Opus 5 · medium effort — a page build from approved copy on shared patterns. *(Executed. Model line added retroactively 2026-09-01 under plans/README.md § "The model line".)*
