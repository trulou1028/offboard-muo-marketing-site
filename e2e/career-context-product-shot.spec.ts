...
test.describe("Career Context product view", () => {
  test("shows one static app view with the responsive crop", async ({ page }) => {
    ...
    await expect(figure.locator("figcaption")).toHaveText("Illustrative Career Context screen with fictional information.");
