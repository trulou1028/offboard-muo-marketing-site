...
- Hero visual *(plan 046)*: the record-card-plus-blank-composer composition that used to sit in "Why this is different".
- CTA: `Get started free` (primary)
...
- Hero visual *(plan 046)*: the Application Packet card plus "every other tool" stack that used to sit in "Why one system".
